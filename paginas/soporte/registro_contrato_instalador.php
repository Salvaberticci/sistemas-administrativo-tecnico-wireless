        ...
        <div class="col-lg-10">
            <div class="card shadow-lg border-0">
                <div class="card-header bg-success text-white text-center py-3">
                    <h4 class="mb-0"><i class="fas fa-file-signature me-2"></i>Registro de Nuevo Contrato - Instalador</h4>
                </div>
                    ...
                    <form id="formContrato" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6 mb-2">
                                <label class="form-label fw-bold">Cédula de Identidad o RIF <span class="text-danger">*</span></label>
                                <input type="text" class="form-control" name="cedula" required placeholder="Ej. V12345678 o J123456789">
                            </div>
                            <div class="col-md-6 mb-2">
                                <label class="form-label fw-bold">Nombre y Apellido Titular <span class="text-danger">*</span></label>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-12 mb-2">
                                <label class="form-label fw-bold">Dirección Exacta y Referencias <span class="text-danger">*</span></label>
                                <textarea class="form-control" name="direccion" rows="2" required placeholder="Dirección completa con referencias..."></textarea>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6 mb-2">
                                <label class="form-label">Teléfono de Contacto 1 <span class="text-danger">*</span></label>
                                <input type="text" class="form-control" name="telefono" required placeholder="0424-1234567">
                            </div>
                            <div class="col-md-6 mb-2">
                                <label class="form-label">Teléfono de Contacto 2</label>
                                <input type="text" class="form-control" name="telefono_secundario" placeholder="0414-7654321">
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6 mb-2">
                                ...
                                <input type="email" class="form-control" name="correo_adicional" placeholder="otro@ejemplo.com">
                            </div>
                        </div>

                        <div class="row mb-3">
                            <div class="col-md-6 mb-2">
                                <label class="form-label fw-bold">Plan de Servicio <span class="text-danger">*</span></label>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6 mb-2">
                                <label class="form-label fw-bold">Fecha de Instalación <span class="text-danger">*</span></label>
                                <input type="date" class="form-control" name="fecha_instalacion" value="<?php echo date('Y-m-d'); ?>" required>
                            </div>
                            <div class="col-md-6 mb-2">
                                <label class="form-label fw-bold">Tipo de Instalación <span class="text-danger">*</span></label>
                                <select class="form-select" name="tipo_instalacion" required>
                                    <option value="">-- Seleccione --</option>
                                    <option value="NUEVO FTTH">Nuevo FTTH</option>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-4 mb-2">
                                ...
                                <input type="number" step="0.01" class="form-control" name="monto_instalacion" id="monto_instalacion" placeholder="0.00">
                            </div>
                            <div class="col-md-4 mb-2">
                                <label class="form-label">Gasto Adicional ($)</label>
                                <input type="number" step="0.01" class="form-control" name="gastos_adicionales" id="gastos_adicionales" value="0" placeholder="0.00">
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                             ...
                             <div class="col-md-4 mb-2">
                                ...
                                <input type="number" class="form-control" name="dias_prorrateo" id="dias_prorrateo" value="0" placeholder="0">
                            </div>
                            <div class="col-md-4 mb-2">
                                <label class="form-label">Monto Prorrateo ($)</label>
                                <input type="number" step="0.01" class="form-control" name="monto_prorrateo_usd" id="monto_prorrateo_usd" readonly placeholder="0.00">
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6 mb-2">
                                ...
                                <input type="number" step="0.01" class="form-control" name="monto_pagar" id="monto_pagar" placeholder="0.00">
                            </div>
                            <div class="col-md-6 mb-2">
                                <label class="form-label fw-bold">Monto Pagado</label>
                                <div class="input-group">
                                    <input type="number" step="0.01" class="form-control" name="monto_pagado" placeholder="0.00">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" name="observaciones" rows="2" placeholder="Observaciones generales..."></textarea>
                        </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6 mb-2">
                            <div class="col-md-6 mb-2">
                                <label class="form-label fw-bold">Tipo de Conexión <span class="text-danger">*</span></label>
                                <select class="form-select" name="tipo_conexion" id="tipo_conexion" required>
                                    <option value="">-- Seleccione --</option>
                        ...
                        <div class="row mb-3 campo-ftth">
                            <div class="col-md-6 mb-2">
                                ...
                                <input type="text" class="form-control" name="mac_onu" placeholder="MAC o Serial">
                            </div>
                            <div class="col-md-6 mb-2">
                                <label class="form-label">Dirección IP Asignada a la ONU</label>
                                <input type="text" class="form-control" name="ip_onu" placeholder="192.168.x.x">
                            </div>
                        </div>
                        ...
                        <div class="row mb-3 campo-ftth">
                            <div class="col-md-6 mb-2">
                                ...
                                <input type="text" class="form-control" name="ident_caja_nap" placeholder="ID Caja NAP">
                            </div>
                            <div class="col-md-6 mb-2">
                                <label class="form-label">Puerto NAP</label>
                                <input type="text" class="form-control" name="puerto_nap" placeholder="Puerto">
                            </div>
                        </div>
                        ...
                        <div class="row mb-3 campo-ftth">
                            <div class="col-md-4 mb-2">
                                ...
                                <input type="text" class="form-control" name="nap_tx_power" placeholder="-25">
                            </div>
                            <div class="col-md-4 mb-2">
                                <label class="form-label">ONU RX Power (dBm)</label>
                                <input type="text" class="form-control" name="onu_rx_power" placeholder="-27">
                            </div>
                            <div class="col-md-4 mb-2">
                                <label class="form-label">Distancia de Drop (m)</label>
                                <input type="text" class="form-control" name="distancia_drop" placeholder="50">
                            </div>
                        </div>
                        ...
                        <div class="row mb-3 campo-radio">
                             <div class="col-md-4 mb-2">
                                ...
                                <input type="text" class="form-control" name="ip" placeholder="192.168.x.x">
                            </div>
                            <div class="col-md-4 mb-2">
                                <label class="form-label">Punto de Acceso</label>
                                <input type="text" class="form-control" name="punto_acceso" placeholder="Nombre AP">
                            </div>
                            <div class="col-md-4 mb-2">
                                <label class="form-label">Valor de Conexión (dBm)</label>
                                <input type="text" class="form-control" name="valor_conexion_dbm" placeholder="-55">
                            </div>
                        </div>
                         ...
                         <div class="row mb-3" style="display:none;">
                            <div class="col-md-6 mb-2">
                                ...
                                <input type="text" class="form-control" name="num_presinto_odn" placeholder="Número de precinto">
                            </div>
                            <div class="col-md-6 mb-2">
                                <label class="form-label">Evidencia de Fibra</label>
                                <input type="text" class="form-control" name="evidencia_fibra" placeholder="Descripción o ubicación">
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-12 mb-2">
                                <label class="form-label">Instalador <span class="text-danger">*</span></label>
                                <input type="text" class="form-control" name="instalador" required placeholder="Nombre del instalador">
                            </div>
                        </div>
                        ...
                        <div class="mb-4">
                            <label class="form-label fw-bold">Firma del Cliente <span class="text-danger">*</span></label>
                            <canvas id="sigCliente" class="signature-pad"></canvas>
                            <button type="button" class="btn btn-sm btn-outline-secondary mt-1" onclick="clearPad('cliente')">Limpiar</button>
                        ...
                        <div class="mb-4">
                            ...
                            <button type="button" class="btn btn-sm btn-outline-secondary mt-1" onclick="clearPad('tecnico')">Limpiar</button>
