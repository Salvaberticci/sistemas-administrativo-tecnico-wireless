                    ...
                    <form id="formReporte">
                        ...
                        <div class="mb-3 position-relative">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" id="cliente_search" placeholder="Buscar por Nombre o ID..." autocomplete="off">
                            </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control" name="modelo_router" placeholder="Ej. TpLink WR840N">
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" name="num_dispositivos" placeholder="Cantidad">
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" name="observaciones" rows="3" placeholder="Describa la falla encontrada..."></textarea>
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Sugerencias al Cliente</label>
                            <textarea class="form-control" name="sugerencias" rows="2" placeholder="Recomendaciones..."></textarea>
                        </div>
                        ...
                        <div class="form-check form-switch mb-3 p-3 bg-light rounded">
                            ...
                            <label class="form-check-label fw-bold" for="solucion_completada">¿Solución de Falla Completada?</label>
                        </div>

                        <div class="mb-3">
                            <label class="form-label fw-bold text-danger">Costo de Visita ($)</label>
                            <input type="number" step="0.01" class="form-control form-control-lg" name="monto_total" value="0.00">
                        </div>
