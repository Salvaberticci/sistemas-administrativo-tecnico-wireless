    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <?php if (isset($_GET['status'])): ?>
                <div
                    class="alert alert-<?php echo $_GET['status'] == 'success' ? 'success' : 'danger'; ?> alert-dismissible fade show">
                    ...
                    <form action="guardar_soporte.php" method="POST" id="formSoporteAdmin">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="date" class="form-control" name="fecha_soporte"
                        ...
                        <div class="mb-3 position-relative">
                            <label class="form-label">Buscar Cliente (Nombre, ID o Cédula)</label>
                            ...
                            <div id="cliente_seleccionado" class="mt-2 p-2 bg-light border rounded d-none">
                                <i class="fas fa-check-circle text-success me-2"></i> <span id="nombre_cliente_sel"
                                    class="fw-bold"></span>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <textarea class="form-control" name="descripcion" rows="3"
                                    placeholder="Describa la falla detalladamente..."></textarea>
                            </div>
                            <div class="col-md-6">
                                <label class="form-label">Sugerencias al Cliente</label>
                                <textarea class="form-control" name="sugerencias" rows="3"
                        ...
                        <div class="form-check form-switch mb-3">
                            ...
                            <label class="form-check-label fw-bold" for="solucion_completada">¿Falla
                                Solucionada?</label>
                        </div>
                        ...
                        <div class="row mb-3 align-items-end">
                            <div class="col-md-4">
                                ...
                                <input type="number" step="0.01" min="0" class="form-control form-control-lg"
                                    name="monto_total" id="monto_total" value="0.00" oninput="calcularDeuda()">
                            </div>
                            <div class="col-md-4">
                                <label class="form-label fw-bold">Monto Abonado/Pagado ($)</label>
                                <input type="number" step="0.01" min="0" class="form-control form-control-lg"
                                    name="monto_pagado" id="monto_pagado" value="0.00" oninput="calcularDeuda()">
                            </div>
                            <div class="col-md-4">
                ...
                if (data.length > 0) {
                    data.forEach(item => {
                        ...
                        a.onclick = (e) => {
                            ...
                            nameSpan.textContent = item.nombre_completo + ' (ID: ' + item.id + ' | Cédula: ' + item.cedula + ')';
