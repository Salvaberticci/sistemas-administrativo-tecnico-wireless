...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($stmt === false) {
        header("Location: gestion_mensualidades.php?message=Error al preparar la consulta de pago.&class=danger");
        exit();
    }
    ...
    if ($stmt->execute()) {
        ...
        header("Location: gestion_mensualidades.php?message=Error al registrar el pago: " . urlencode($stmt->error) . "&class=danger");
    }
