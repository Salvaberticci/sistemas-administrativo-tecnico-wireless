...
<main class="main-content">
    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <div class="row mb-4">
                <div class="col-12">
                    <h3 class="fw-bold text-primary"><i class="fa-solid fa-file-invoice-dollar me-2"></i>Conciliación: Capture vs Banco</h3>
                    <p class="text-muted">Sube el Excel del Banco y el Capture del Pago Móvil para verificar si la operación fue exitosa.</p>
                </div>
            </div>
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-5">
                    ...
                    <div class="card shadow-sm mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <div id="excel-info" class="mt-3 text-center text-success fw-bold small" style="display: none;"></div>
                        </div>
                    </div>
                ...
                <div class="col-lg-7">
                    <div class="card shadow-sm h-100">
                        <div class="card-header bg-white fw-bold"><i class="fa-solid fa-magnifying-glass-chart me-2"></i>Resultados del Análisis</div>
                        <div class="card-body d-flex flex-column justify-content-center">
                            
                            <!-- Estado del Proceso -->
                            <div id="processing-status" class="text-center py-5" style="display: none;">
                                <div class="spinner-border text-primary mb-3" role="status" style="width: 3rem; height: 3rem;"></div>
                                <h5 class="fw-bold animate__animated animate__pulse animate__infinite">Analizando imagen con IA...</h5>
                                ...
                                <div class="progress mt-3 mx-auto" style="width: 80%; height: 8px;">
                                    <div id="ocr-progress" class="progress-bar progress-bar-striped progress-bar-animated" style="width: 0%"></div>
                                </div>
                            </div>
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-6 border-end">
                                                <h6 class="fw-bold text-muted small text-uppercase">Detectado en Capture</h6>
                                                <p class="fs-4 fw-bold text-dark mb-0" id="ref-ocr">---</p>
                                            </div>
                                            <div class="col-md-6">
                                                <h6 class="fw-bold text-success small text-uppercase"><i class="fa-solid fa-database me-1"></i> Datos del Banco</h6>
                            ...
                            <div id="result-error" class="result-card text-center py-4" style="display: none;">
                                ...
                                <div class="card border-danger bg-light mx-4 text-start shadow-sm">
                                    <div class="card-body">
                                        <p class="mb-1"><strong>🔍 Número Buscado (OCR):</strong> <span id="ref-ocr-error" class="fw-bold fs-5 text-danger"></span></p>
                                        <hr>
                                        <p class="text-muted small mt-2 mb-0">
                                            <i class="fa-solid fa-triangle-exclamation me-1"></i> <strong>Posibles causas:</strong><br>
                                ...
                                <button class="btn btn-outline-secondary mt-3" onclick="retryOCR()">Intentar de nuevo</button>
                            </div>
...
<script>
    ...
    function processExtractedText(text) {
        ...
        if (tokens.length === 0) {
            showError("No se detectaron números.");
            return;
        }
        ...
        for (let t = 0; t < tokens.length; t++) {
            ...
            for (let r = 0; r < bankData.length; r++) {
                ...
                if (cellValue.indexOf(cleanToken) !== -1 && cleanToken.length > 5) {
                    foundMatch = row;
    ...
    function showSuccess(ref, rowData) {
        ...
        for (let k = 0; k < keys.length; k++) {
            ...
            // Lógica para renombrar o esconder llaves __EMPTY
